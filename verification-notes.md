...
2026-08-18 güncel görsel doğrulama: Ana sayfa masaüstü header ve Dersleri Keşfet bölümü düzenli görünüyor. Soru-Cevap önizlemesinde MEB K-12 Eğitim Müfredatı → İlkokul → 1. Sınıf breadcrumb yolu görünür ve tıklanabilir düğmeler olarak render ediliyor. Soru-Cevap başlığı seçili sınıf bağlamını doğru gösteriyor. Mobil doğrulamada özellikle sınıf kartı hover önizlemesinin dokunmatik davranışı ayrıca kontrol edilecek.

2026-08-18 mobil görsel doğrulama: Ana sayfa sınıf kartının kapak illüstrasyonu görünür ve kart mobil genişliğe uyuyor. Soru-Cevap breadcrumb satırları çok satırlı düzene geçerek taşmıyor; seçili sınıf başlığı okunabilir durumda. Hover önizlemesi mobilde hover’a bağımlı olmayacak şekilde kart içeriğiyle birlikte erişilebilir olmalı.
