...
const trpcMock = vi.hoisted(() => {
  ...
  categories: { list: hook([]), create: hook(), importCurriculum: hook(), setInstitutionStatus: hook(), update: hook(), setStatus: hook(), remove: hook() },
  questions: { list: hook([]), create: hook(), remove: hook() },
  ai: { generateQuestion: hook() },
  contents: { list: hook([]), create: hook(), archive: hook(), remove: hook() },
  tests: { list: hook([]), create: hook(), remove: hook() },
  admin: { users: hook([{ id: 7, name: "Ayşe Öğrenci", email: "ayse@example.com", role: "member", lastSignedIn: new Date() }]), updateUserRole: hook(), testProviderConnection: hook(), settings: hook([]), searchConsoleStatus: hook({ configured: false, propertyUrl: null, verificationStatus: "not_configured", sitemapStatus: "not_configured", lastError: null }), mediaAssets: hook([]), mediaTransferJobs: hook([]), createMediaAsset: hook(), uploadMediaAsset: hook(), archiveMediaAsset: hook(), createMediaTransferJob: hook(), retryMediaTransferJob: hook(), cancelMediaTransferJob: hook(), linkMediaAsset: hook(), mediaAssetLinks: hook([]), unlinkMediaAsset: hook(), saveSetting: hook(), newsCategories: hook([]), createNewsCategory: hook(), removeNewsCategory: hook(), homeSlides: hook([]), createHomeSlide: hook(), updateHomeSlide: hook(), deleteHomeSlide: hook(), popularEducationCategories: hook([]), savePopularEducationCategories: hook() },
    security: { list: hook([]) },
  };
});
