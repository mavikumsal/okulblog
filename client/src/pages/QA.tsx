...
export default function QA() {
  ...
  const ask = trpc.member.askQuestion.useMutation({ onSuccess: () => { toast.success("Sorunuz moderasyon kuyruğuna alındı."); setTitle(""); setBody(""); setImageUrl(""); setIsAskOpen(false); qa.refetch(); }, onError: error => toast.error(error.message) });
