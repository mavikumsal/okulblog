      ...
      <main>
        ...
        <section id="baslangic" className="relative overflow-hidden bg-[#06172c] pt-[78px] text-white">
          ...
          <div className="container relative grid gap-8 py-8 sm:gap-10 sm:py-12 lg:min-h-[400px] lg:grid-cols-[46%_54%] lg:items-center lg:py-8">
            ...
            <div className="relative mx-auto w-full max-w-[min(100%,430px)] sm:max-w-[520px] lg:ml-auto lg:w-full lg:max-w-[620px] lg:-translate-y-1">
              <div className="absolute -left-5 top-16 h-40 w-40 rounded-full bg-[#c9e4dc]/20 blur-3xl" />
              <div className="relative">
              <div className="relative z-10 w-full max-w-[430px] overflow-hidden rounded-[20px] border border-white/25 bg-white/95 p-4 text-[#15344e] shadow-[0_16px_40px_rgba(31,41,55,.24)] sm:rounded-[22px] sm:p-3 lg:p-2.5">
              ...
              {miniHeroClassData.map((mini, index) => <div key={mini.name} className={`absolute hidden w-[150px] rounded-[18px] border border-white/55 bg-white/90 p-3 text-[#17354d] shadow-[0_15px_28px_rgba(31,41,55,.18)] sm:block ${index === 0 ? "-right-10 top-12 rotate-[6deg]" : "-right-16 top-36 rotate-[10deg]"}`}><p className="text-[10px] font-bold text-[#2864d8]">{mini.name}</p><div className="mt-3 grid h-12 place-items-center rounded-xl bg-gradient-to-br from-[#dceef0] to-[#e8ddff] text-[#2864d8]"><BookOpen size={22} /></div><p className="mt-2 truncate text-xs font-extrabold">{mini.summary.previews[0]?.title ?? "Yeni öğrenme yolu"}</p><p className="mt-1 text-[10px] text-[#6f7d87]">{mini.summary.total} içerik</p><span className="mt-2 inline-flex items-center gap-1 text-[10px] font-bold text-[#0f8f8b]">Devam Et <ArrowRight size={12} /></span></div>)}
