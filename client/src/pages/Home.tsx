      ...
      <main>
        ...
        <section id="baslangic" className="relative overflow-hidden bg-gradient-to-br from-[#1f5fe8] via-[#3f35c4] to-[#6322a0] text-white">
          ...
          <div className="container relative grid gap-4 py-5 sm:gap-6 sm:py-7 lg:min-h-[280px] lg:grid-cols-[1.02fr_.98fr] lg:items-center lg:py-7">
            ...
            <div className="relative mx-auto w-full max-w-[min(100%,320px)] sm:max-w-[340px] lg:ml-auto lg:w-full lg:max-w-[340px]">
              ...
              {(user?.role === "admin" || user?.role === "teacher") && <QuestionProductionDashboard compact className="mt-2 w-full max-w-[260px] shadow-[0_12px_30px_rgba(0,0,0,.2)] sm:max-w-[280px] lg:max-w-[310px]" />}
