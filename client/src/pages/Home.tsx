      ...
      <main>
        ...
        <section id="baslangic" className="relative overflow-hidden bg-gradient-to-br from-[#1f5fe8] via-[#3f35c4] to-[#6322a0] text-white">
          ...
          <div className="container relative grid gap-4 py-5 sm:gap-6 sm:py-7 lg:min-h-[280px] lg:grid-cols-[1.02fr_.98fr] lg:items-center lg:py-7">
            ...
            <div className="relative mx-auto w-full max-w-[210px] sm:max-w-[250px] lg:absolute lg:right-10 lg:top-1/2 lg:w-[235px] lg:-translate-y-1/2">
              <div className="absolute -left-5 top-16 h-40 w-40 rounded-full bg-[#c9e4dc]/20 blur-3xl" />
              <div className="relative overflow-hidden rounded-[18px] border border-white/25 bg-white/95 p-2 text-[#15344e] shadow-[0_16px_40px_rgba(31,41,55,.24)] sm:rounded-[22px] sm:p-2.5">
                <div className="flex items-center justify-between border-b border-[#e1e2d9] pb-3"><div className="flex items-center gap-2.5"><span className="grid h-9 w-9 place-items-center rounded-xl bg-[#cce9df] text-[#176559]"><Search size={17} /></span><div><p className="text-xs font-bold sm:text-sm">Öğrenme yolu</p><p className="text-[11px] text-[#75838a]">Adım adım keşfet</p></div></div><span className="rounded-full bg-[#f5e4b6] px-2 py-1 text-[9px] font-bold text-[#855f20]">AKILLI SEÇİM</span></div>
