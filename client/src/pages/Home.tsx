...
const contentAreas = [
  { name: "Testler", value: "test", detail: "Ölçme ve değerlendirme", path: "/panel/testler", icon: Target, accent: "bg-[#e7b354]", ink: "text-[#7b4d0e]" },
  { name: "Dokümanlar", value: "document", detail: "Düzenli kaynak arşivi", path: "/panel/dokumanlar", icon: FileText, accent: "bg-[#b8ddd4]", ink: "text-[#155d55]" },
  { name: "Simülasyonlar", value: "simulation", detail: "Görerek ve deneyerek öğren", path: "/panel/simulasyonlar", icon: Layers3, accent: "bg-[#d8c8e8]", ink: "text-[#60447a]" },
  { name: "Videolar", value: "video", detail: "Odaklı anlatımlar", path: "/panel/videolar", icon: Video, accent: "bg-[#f3c7bd]", ink: "text-[#873d31]" },
  { name: "Oyunlar", value: "game", detail: "Aktif tekrar deneyimi", path: "/panel/oyunlar", icon: Gamepad2, accent: "bg-[#bcd5ee]", ink: "text-[#24567b]" },
  { name: "Haberler", value: "news", detail: "Eğitimden seçili gündem", path: "/panel/haberler", icon: BookOpen, accent: "bg-[#d6dfad]", ink: "text-[#536a1d]" },
];
...
export default function Home() {
  ...
  const submitContact = (event: React.FormEvent<HTMLFormElement>) => {
    ...
    if (recipient) window.location.href = `mailto:${recipient}?subject=${encodeURIComponent(`OkulBlog iletişim mesajı - ${contactForm.name.trim()}`)}&body=${encodeURIComponent(`${contactForm.message.trim()}\n\nGönderen: ${contactForm.name.trim()}\nE-posta: ${contactForm.email.trim()}`)}`;
